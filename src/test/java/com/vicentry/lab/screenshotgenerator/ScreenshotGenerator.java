package com.vicentry.lab.screenshotgenerator;
...
public class ScreenshotGenerator extends Initializer {
	...
	public static void generateScreenshot(ITestResult r) throws IOException {
		if (r.isSuccess()) {
			...
			log.log(LogStatus.FAIL, r.getName() + " test case failed", log.addScreenCapture(path));
		}
		reports.endTest(log);
		reports.flush();
	}
	...
	public static String takeScreenshot(String name) throws IOException {
		...
		File dst = new File("C:/Users/fabia/workspace/H1_DDDTest/screenshot/" + name + ".png");
