package com.vicentry.lab.inputReader;
...
public class InputReader {
	...
	public static boolean verifyRunMode(String TestCaseName) throws IOException {
		...
		// XSSF - .xlsx, HSSF - .xls
		XSSFWorkbook workbook=new XSSFWorkbook(new FileInputStream(new File("src/test/resources/com/vicentry/lab/Inputs/inputcontroller.xlsx")));
	...
	public static Object[][] collectMultiData(String TestCaseName) throws IOException {
		XSSFWorkbook workbook=new XSSFWorkbook(new FileInputStream(new File("src/test/resources/com/vicentry/lab/Inputs/multiData.xlsx")));
		XSSFSheet TcSheet=workbook.getSheet(TestCaseName);
		int TcRow=TcSheet.getLastRowNum();
